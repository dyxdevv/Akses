...
-- Improved chat handler with better command parsing
...
-- Check if the player is in a private server
local function isPrivateServer()
    return game.PrivateServerId ~= "" and game.PrivateServerId ~= "0"
end

-- Notify player if in a private server
if isPrivateServer() then
    game:GetService("StarterGui"):SetCore("SendNotification", {
        Title = "Private Server Detected",
        Text = "You are in a private server. Commands are enabled.",
        Duration = 5
    })
end